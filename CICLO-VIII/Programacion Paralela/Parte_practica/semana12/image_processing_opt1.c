...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "image_processing_opt1",
        "sources": [
            "/run/media/alext/HDD/Archivos/ApuntesSM/CICLO-VIII/Programacion Paralela/Parte_practica/semana12/image_processing_opt1.pyx"
        ]
    },
    "module_name": "image_processing_opt1"
}
END: Cython Metadata */
...
#define __PYX_HAVE__image_processing_opt1
#define __PYX_HAVE_API__image_processing_opt1
/* Early includes */
#include <string.h>
#include <stdio.h>
#include "pythread.h"
...
/* Module declarations from 'image_processing_opt1' */
#define __Pyx_MODULE_NAME "image_processing_opt1"
extern int __pyx_module_is_main_image_processing_opt1;
int __pyx_module_is_main_image_processing_opt1 = 0;

/* Implementation of 'image_processing_opt1' */
...
static const char __pyx_k_image_processing_opt1[] = "image_processing_opt1";
static const char __pyx_k_compute_internal_pixel[] = "compute_internal_pixel";
static const char __pyx_k_image_processing_opt1_pyx[] = "image_processing_opt1.pyx";
static PyObject *__pyx_n_s_MemoryError;
static PyObject *__pyx_n_s_cline_in_traceback;
static PyObject *__pyx_n_s_compute_internal_pixel;
static PyObject *__pyx_n_s_i;
static PyObject *__pyx_n_s_idx;
static PyObject *__pyx_n_s_image;
static PyObject *__pyx_n_s_image_processing_opt1;
static PyObject *__pyx_kp_s_image_processing_opt1_pyx;
...
static PyObject *__pyx_pf_21image_processing_opt1_compute_internal_pixel(CYTHON_UNUSED PyObject *__pyx_self, arrayobject *__pyx_v_image, int __pyx_v_idx, int __pyx_v_w); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_21image_processing_opt1_1compute_internal_pixel(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_21image_processing_opt1_1compute_internal_pixel = {"compute_internal_pixel", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_21image_processing_opt1_1compute_internal_pixel, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_21image_processing_opt1_1compute_internal_pixel(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("compute_internal_pixel (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_image,&__pyx_n_s_idx,&__pyx_n_s_w,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_idx)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("compute_internal_pixel", 1, 3, 3, 1); __PYX_ERR(0, 3, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_w)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("compute_internal_pixel", 1, 3, 3, 2); __PYX_ERR(0, 3, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "compute_internal_pixel") < 0)) __PYX_ERR(0, 3, __pyx_L3_error)
      }
    ...
    __pyx_v_w = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_w == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 3, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("compute_internal_pixel", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 3, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("image_processing_opt1.compute_internal_pixel", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  __pyx_r = __pyx_pf_21image_processing_opt1_compute_internal_pixel(__pyx_self, __pyx_v_image, __pyx_v_idx, __pyx_v_w);
...
static PyObject *__pyx_pf_21image_processing_opt1_compute_internal_pixel(CYTHON_UNUSED PyObject *__pyx_self, arrayobject *__pyx_v_image, int __pyx_v_idx, int __pyx_v_w) {
  int __pyx_v_val;
  int __pyx_v_i;
  int __pyx_v_width;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("compute_internal_pixel", 0);

  /* "image_processing_opt1.pyx":5
 * def compute_internal_pixel(array.array image, int idx, int w):
 *     cdef int val
 *     cdef int i = idx             # <<<<<<<<<<<<<<
 *     cdef int width = w
 ...
 */
  ...
  /* "image_processing_opt1.pyx":10
 *     val = image.data.as_ints[i] + image.data.as_ints[i+1] + image.data.as_ints[i-1] + image.data.as_ints[i-width] + image.data.as_ints[i+width]
 *     val += image.data.as_ints[i+1+width] + image.data.as_ints[i+1-width] + image.data.as_ints[i-1+width] + image.data.as_ints[i-1-width]
 *     return val/9             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyInt_From_long(__Pyx_div_long(__pyx_v_val, 9)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 10, __pyx_L1_error)
...
static int __pyx_pymod_exec_image_processing_opt1(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_image_processing_opt1},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_compute_internal_pixel, __pyx_k_compute_internal_pixel, sizeof(__pyx_k_compute_internal_pixel), 0, 0, 1, 1},
  {&__pyx_n_s_i, __pyx_k_i, sizeof(__pyx_k_i), 0, 0, 1, 1},
  {&__pyx_n_s_idx, __pyx_k_idx, sizeof(__pyx_k_idx), 0, 0, 1, 1},
  {&__pyx_n_s_image, __pyx_k_image, sizeof(__pyx_k_image), 0, 0, 1, 1},
  {&__pyx_n_s_image_processing_opt1, __pyx_k_image_processing_opt1, sizeof(__pyx_k_image_processing_opt1), 0, 0, 1, 1},
  {&__pyx_kp_s_image_processing_opt1_pyx, __pyx_k_image_processing_opt1_pyx, sizeof(__pyx_k_image_processing_opt1_pyx), 0, 0, 1, 0},
 ...
 *     cdef int i = idx
 */
  __pyx_tuple_ = PyTuple_Pack(6, __pyx_n_s_image, __pyx_n_s_idx, __pyx_n_s_w, __pyx_n_s_val, __pyx_n_s_i, __pyx_n_s_width); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple_);
  __Pyx_GIVEREF(__pyx_tuple_);
  __pyx_codeobj__2 = (PyObject*)__Pyx_PyCode_New(3, 0, 6, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple_, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_image_processing_opt1_pyx, __pyx_n_s_compute_internal_pixel, 3, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__2)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initimage_processing_opt1(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initimage_processing_opt1(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_image_processing_opt1(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_image_processing_opt1(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_image_processing_opt1(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'image_processing_opt1' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_image_processing_opt1(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("image_processing_opt1", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_image_processing_opt1) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "image_processing_opt1")) {
      if (unlikely(PyDict_SetItemString(modules, "image_processing_opt1", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     cdef int i = idx
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_21image_processing_opt1_1compute_internal_pixel, NULL, __pyx_n_s_image_processing_opt1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_compute_internal_pixel, __pyx_t_1) < 0) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "image_processing_opt1.pyx":1
 * from cpython cimport array             # <<<<<<<<<<<<<<
 * 
 * def compute_internal_pixel(array.array image, int idx, int w):
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init image_processing_opt1", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init image_processing_opt1");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
