...
#
# python camara.py --rostro cascadas/haarcascade_frontalface_default.xml  --video video/videoIA.ogv
...
salida = cv2.VideoWriter('videoReconocimiento.avi',cv2.VideoWriter_fourcc(*'XVID'),20.0,(640,480))
# if not args.get("video",False):
#     camara = cv2.VideoCapture(0)
#     salida = cv2.VideoWriter('videoIAReconocimiento.avi',cv2.VideoWriter_fourcc(*'XVID'),20.0,(640,480))
